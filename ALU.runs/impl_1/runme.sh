...
HD_PWD='C:/Users/squid/OneDrive/Documents/Vivado/2023/ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_s.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_s.tcl -notrace
